...
<header>
  <div class="nav-left">
    <a href="index.html" class="logo">VANTERA</a>
  </div>
  ...
  <div class="nav-icons">
    ...
    <div class="menu-wrapper">
      ...
      <div class="menu-box" id="menuBox">
        <a href="travel.jsp" class="menu-item" value="travel">旅行用
        </a>
        <a href="plane.jsp" class="menu-item" value="boarding">登機用
        </a>
        <a href="kids.jsp" class="menu-item" value="family">親子用
        </a>
